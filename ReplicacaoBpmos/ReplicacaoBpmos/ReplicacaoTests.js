...
exports['BancoMatriz-001'] = function (test)
{
    var bMatriz = qdb.banco_matriz;
    ...
    var esperado_um_bMatriz = [{ chave: 'A1', dado: 'um' }];
    assert.deepEqual(esperado_um_A, A.pesquisar('um'), "dado um banco A");
    assert.deepEqual(esperado_um_bMatriz, bMatriz.pesquisar_rep('um'), "dado um banco bMatriz");
    ...
    var esperado_dois_A = [{ chave: 'A3', dado: 'três' }];
    var esperado_dois_bMatriz = [{ chave: 'A3', dado: 'três' }];
    assert.deepEqual(esperado_dois_A, A.pesquisar('três'), "dado três banco A");
    assert.deepEqual(esperado_dois_bMatriz, bMatriz.pesquisar_rep('três'), "dado três banco bMatriz");
