...
export class TApplication {
        ...
        this.sammy = Sammy(function () {
            ...
            this.get('#show/:class/:params', function () {
                ...
                if (self.AuthenticationRequired && !self.Authenticated &&
                    this.params["class"].toUpperCase() != self.LoginPage.toUpperCase() &&
                    this.params["class"].toUpperCase() != self.igonreaAthenticationPage.toUpperCase() ) {
    ...
    private loadJSLibraries(modulesName: Array<string>, callBack: () => void) {
